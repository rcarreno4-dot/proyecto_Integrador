...
import view.BitacoraFrame;
import view.DirectorApprovalFrame;
import view.DirectorDashboardFrame;
import view.EvidenceFrame;
import view.FindingsConsolidationFrame;
import view.AppIconFactory;
import view.LoginFrame;
import view.PracticeRegistrationFrame;
import view.ReportsFrame;
import view.RubricEvaluationFrame;
import view.StudentDashboardFrame;
import view.StudentSelfRegistrationFrame;
import view.TemplateConfigFrame;
import view.TeacherDashboardFrame;
import view.TeacherRegistrationFrame;
import view.ValidationFrame;
...
public class AbrirMenuVistas extends JFrame {
    public AbrirMenuVistas() {
        ...
        grid.add(button("Registro practica", () -> openAs(Role.ESTUDIANTE, () -> new PracticeRegistrationFrame(Role.ESTUDIANTE))));
